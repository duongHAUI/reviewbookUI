  ...
  vi: {
    ...
    FORM_MESSAGE: {
      ...
      ERROR: {
        ...
        MAX_LENGTH: (name, length) => `${name} không được vượt quá ${length} ký tự.`,
        MIN_LENGTH: (name, length) => `${name} không được ít hơn ${length} ký tự.`,
    ...
    FORM_FIELD: {
      ...
      FirstName: 'Tên',
      LastName: 'Họ',
      comfirm_password: 'Mật khẩu nhập lại',
      fullname: 'Họ tên',
      book_name: 'Tên sách',
      isbn: 'Mã ISBN sách'
    },
